...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/yowmamasita/MPVKit/releases/download/0.41.0-n8.1-pts-fix-v4/Libmpv.xcframework.zip",
            checksum: "7d3cdaf8c342eb12815717bee6f4cf15103d221ae8d653426654ac05703b2af2"
        ),
