...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/yowmamasita/MPVKit/releases/download/0.41.0-n8.1-pts-fix-v3/Libmpv.xcframework.zip",
            checksum: "5383e836484e60552a68a1a621e20b7d4f5af2f5c86a2fb41063c9926884a3e4"
        ),
