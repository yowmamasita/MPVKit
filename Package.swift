...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/yowmamasita/MPVKit/releases/download/0.41.0-n8.1-pts-fix-v7/Libmpv.xcframework.zip",
            checksum: "15aa3ffaf32518077ba9cc4cea8924948eda07726feebe483b8f1633aa0e1b43"
        ),
